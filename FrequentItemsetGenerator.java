 ...
 * <a href="https://en.wikipedia.org/wiki/Apriori_algorithm">Apriori
 * algorithm</a> for frequent itemset generation.
 * 
...
// First generate the candidates.
	 ...
	 * list.
	 * 
	 * @param map the map mapping an itemset size to the list of frequent itemsets
	 *            of that size.
	 ...
	 * @param supportCountMap the support count map to which to write the support
	 *                        counts of each item.
	 * @param minimumSupport  the minimum support.
